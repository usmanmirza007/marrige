                    ...
                    <ScrollView >
                        <ImageBackground source={require('./../image/Rbg.png')} style={{ width: '100%', height: '100%', marginTop: hp('0%') }}>
                            ...
                            <View style={styles.firstInput}>
                                <Image source={require('./../image/username-icon.png')} style={{ width: 18, height: 23, marginLeft: hp('2%'), alignSelf: 'center' }} />
                            ...
                            <View style={styles.firstInput}>
                                <Image source={require('./../image/password-icon.png')} style={{ width: 18, height: 20, marginLeft: hp('2%'), alignSelf: 'center' }} />
                            ...
                            <View style = {{alignItems: 'center', marginTop: hp('2%')}}>
                                <Text style = {{fontSize: 15, marginBottom: hp('60%'), color: '#ccc'}}>Not Registered?<Text style = {{fontSize: 15, fontWeight: 'bold', color: '#f3ae6a'}} onPress={() => this.props.navigation.navigate('registration')}> Signup</Text></Text>
                            </View>
                        </ImageBackground>
                    </ScrollView>
